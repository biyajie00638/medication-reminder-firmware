...
static bool i2s_init_driver() {
    ...
    // For ESP32-S3, MCLK is enabled via fixed_mclk in i2s_config
    // i2s_mclk_gpio_select is not available in this IDF version
    // MCLK should auto-start when I2S runs with fixed_mclk > 0
...
// ============================================================
// PLAYED-ID DEDUP (anti-repeat) - forward declarations
// ============================================================
